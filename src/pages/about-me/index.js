      ...
      <section
        ...
        <div className="flex" >
          <ul className="list-disc ml-5 mt-9 space-y-2">
            <p className="mb-4">Hi!&#128075; My name is <strong>Rishav Thapliyal</strong></p>
            ...
            <li>Currently enjoying my time with golang and nestjs farmework</li>
            <li>When I'm not coding, I enjoy reading, watching anime, playing video games.</li>
          </ul>
        </div >
      </section >
